...
namespace SpotifyAPI.SpotifyWebAPI
{
    ...
    {
        private Action<String, String, String> funcOne;
        private Action<String, String, int, String, String> funcTwo;
        private AuthType type;

        public SimpleHttpServer(int port, Action<String, String, String> func, AuthType type)
            : base(port)
        {
            this.funcOne = func;
            this.type = type;
        ...
        public SimpleHttpServer(int port, Action<String, String, int, String, String> func, AuthType type)
            : base(port)
        {
            this.funcTwo = func;
            this.type = type;
